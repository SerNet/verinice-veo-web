...
"VEO_FEATURE_FLAG_RI_DIALOG_ADDITIONAL_PROPERTIES": "'${VEO_FEATURE_FLAG_RI_DIALOG_ADDITIONAL_PROPERTIES}'",
"VEO_FEATURE_FLAG_USER_SETTINGS": "'${VEO_FEATURE_FLAG_USER_SETTINGS}'"
}'
