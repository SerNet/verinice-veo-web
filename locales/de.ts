export default {
  ...
  'editor.formschema.delete.control.text': 'Möchten Sie das Element wirklich aus dem Formschema entfernen?',
  ...
  'editor.formschema.translation.edit.language.input.label': 'Sprache',
  'editor.formschema.translation.edit.language.input.label.text': 'Wählen Sie eine Sprache aus',
  'editor.formschema.translation.edit.supportedlanguages.input.label': 'Sprachen',
  'editor.formschema.translation.edit.supportedlanguages.input.label.text': 'Unterstützte Sprachen',
  ...
  'editor.formschema.wizard.forceownschema': 'Existierendes Objektschema selbst hochladen.',
  'editor.formschema.wizard.generate.generate': 'Vorgenerieren',
  'editor.formschema.wizard.generate.none': 'Mit leerem Formschema starten',
  'editor.formschema.wizard.generate.title': 'Möchten Sie ein Formschema vorgenerieren?',
  'editor.formschema.wizard.import': 'Formschema importieren',
  'editor.formschema.wizard.import.back': 'Stattdessen ein neues Formschema erstellen',
  'editor.formschema.wizard.import.description': 'Existierendes Formschema importieren und modifizieren',
  ...
  'editor.formschema.wizard.objectschema.required': 'Sie müssen ein Objektschema angeben',
  ...
  'unit.data.delete.headline': 'Objekt löschen',
  ...
  'unit.forms.header.title': 'Objektname',
  ...
  'unit.forms.tooltip.clone': 'Objekt klonen',
  'unit.forms.tooltip.delete': 'Objekt löschen',
  'unit.forms.tooltip.edit': 'Objekt bearbeiten',
