export default {
  ...
  'editor.formschema.delete.control.text': 'Möchten Sie das Element "{element}" wirklich aus dem Formular entfernen?',
  ...
  'editor.formschema.edit.input.headline': 'Input Element "{element}" anpassen',
