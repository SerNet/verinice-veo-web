export default {
  ...
  'editor.formschema.create.title.text': 'Name des neuen Formulars',
  'editor.formschema.create.type': 'Formulartyp',
  'editor.formschema.create.type.text': 'Typ des neuen Formulars',
