export default {
  errors: {
    ...
    FETCH_SCHEMA_FAILED: "Das Schema {name} konnten nicht geladen werden!",
    FETCH_LINKS_FAILED: "Die Links des Elements {id} konnten nicht geladen werden!",
    FETCH_HISTORY_FAILED: "Die Änderungen des Elements {id} konnten nicht geladen werden!"
  }
} as ProjectLocale;
