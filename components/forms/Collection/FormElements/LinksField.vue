<template>
  <div v-if="visible" class="vf-links-field" :class="options && options.class" :style="options && options.style">
    ...
    <div v-for="(val, i) in value" :key="i" class="d-flex flex-row">
      <LinksFieldRow
        ...
        @input="onInput"
      />
      <v-btn dark fab elevation="0" x-small color="primary" class="vf-btn-remove ma-5 mt-4" @click="removeRow(i)">
