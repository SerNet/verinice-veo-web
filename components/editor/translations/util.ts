 ...
 */
export const editorTranslationsToFormsTranslations = (translations: IEditorTranslations, sources: TRANSLATION_SOURCE[] = [TRANSLATION_SOURCE.UNSPECIFIED]): IVeoFormsTranslations => Object.entries(translations).reduce((_translations, [key, value]) => {
 ...
 * @returns The converted translations
 */
export const formsTranslationsToEditorTranslations = (translations: IVeoFormsTranslations, source: TRANSLATION_SOURCE, existingEditorTranslation: IEditorTranslations = {}, replace = true): IEditorTranslations => {
