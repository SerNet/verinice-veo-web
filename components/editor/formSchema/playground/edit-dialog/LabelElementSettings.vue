...
-->
<template>
  <section data-component-name="label-element-settings">
    <h2 class="text-h2">
      {{ t('common') }}
    </h2>
    <BaseCard>
...
<i18n src="~/locales/base/components/editor-form-schema-playground-edit-dialog-label-element-settings.json"></i18n>
