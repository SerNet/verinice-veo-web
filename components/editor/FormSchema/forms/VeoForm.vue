...
import Label from '~/components/editor/FormSchema/forms/Label.vue'
import Control from '~/components/editor/FormSchema/forms/Control.vue'
import Layout from '~/components/editor/FormSchema/forms/Layout.vue'
import Wrapper from '~/components/editor/FormSchema/forms/Wrapper.vue'
