...
{
  "en": {
  "text": "The form \"{name}\" has been edited. Do you really want to leave this page?",
  "headline": "Close"
  },
  "de": {
    "text": "Das Formular \"{name}\" wurde bearbeitet. Wollen Sie wirklich die Seite verlassen?",
    "headline": "Verlassen"
  }
}
</i18n>
