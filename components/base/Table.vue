 ...
 */
const toNodeChildren = (items: ReturnType<TableRenderer>): VNodeArrayChildren => ([] as (VNode | string)[]).concat(items as VNode[]);
/**
...
const render = () => isPaginatedResponse(props.items) ?
  h(VDataTableServer, {
    ...sharedProps.value,
