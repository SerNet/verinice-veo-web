export default {
  ...
  publicRuntimeConfig: {
    ...
    apiUrl: (process.env.VEO_API_URL || 'https://api.veo.develop.cpmsys.io/') + 'veo',
    formsApiUrl: (process.env.VEO_API_URL || 'https://api.veo.develop.cpmsys.io/') + 'forms',
    historyApiUrl: (process.env.VEO_API_URL || 'https://api.veo.develop.cpmsys.io/') + 'history',
    reportsApiUrl: (process.env.VEO_API_URL || 'https://api.veo.develop.cpmsys.io/') + 'reporting',
