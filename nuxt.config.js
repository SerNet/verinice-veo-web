export default {
  ...
  publicRuntimeConfig: {
    ...
    apiUrl: process.env.VEO_DEFAULT_API_URL || 'https://api.develop.verinice.com/veo123',
    formsApiUrl: process.env.VEO_FORMS_API_URL || 'https://api.develop.verinice.com/forms123',
    historyApiUrl: process.env.VEO_HISTORY_API_URL || 'https://api.develop.verinice.com/history123',
    reportsApiUrl: process.env.VEO_REPORTING_API_URL || 'https://api.develop.verinice.com/reporting123',
