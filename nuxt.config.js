export default {
  ...
  publicRuntimeConfig: {
    ...
    apiUrl: process.env.VEO_API_URL || 'https://veo.develop.cpmsys.io/',
    formsApiUrl: process.env.VEO_FORMS_API_URL || 'https://veo-forms.develop.cpmsys.io/',
    historyApiUrl: process.env.VEO_HISTORY_API_URL || 'https://veo-history.develop.cpmsys.io/',
    reportsApiUrl: process.env.VEO_REPORTING_API_URL || 'https://veo-reporting.develop.cpmsys.io/',
