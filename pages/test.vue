...
export default Vue.extend({
        ...
        properties: {
              ...
              process_SensitiveData: {
                ...
                properties: {
                  ...
                  attributes: {
                    type: 'object',
                    properties: {
                      process_SensitiveData_SensitiveData: {
                        title: 'Data processing of particularly sensitive data?',
                        type: 'boolean'
                      },
                      ...
                      process_SensitiveData_notification3343GDPR: {
                        title: 'Notification procedure Art. 33,34 GDPR?',
                        type: 'boolean'
                      },
                      process_SensitiveData_secrecy203STGB: {
                        title: 'Persons subject to secrecy according to §203 StGB?',
                        type: 'boolean'
                      }
                    }
                  }
              ...
              process_GeneralInformation: {
                ...
                properties: {
                  ...
                  attributes: {
                    type: 'object',
                    properties: {
                      process_GeneralInformation_tags: {
                        title: 'Tags',
                        type: 'string'
                      },
              ...
              process_AccessAuthorization: {
                ...
                properties: {
                  ...
                  attributes: {
                    type: 'object',
                    properties: {
                      process_AccessAuthorization_authorizationConcept: {
                        title: 'Authorization concept?',
                        type: 'boolean'
                      },
                      process_AccessAuthorization_description: {
                        title: 'Description of the authorization concept',
                        type: 'string'
                      },
              ...
              process_InternalRecipient: {
                ...
                properties: {
                  ...
                  attributes: {
                    type: 'object',
                    properties: {
                      process_InternalRecipient_InternalRecipient: {
              ...
              process_ProcessingDetails: {
                ...
                properties: {
                  ...
                  attributes: {
                    type: 'object',
                    properties: {
                      process_ProcessingDetails_intendedPurpose: {
                      ...
                      process_ProcessingDetails_operationalStage: {
                        ...
                        enum: [
                          'process_ProcessingDetails_operationalStage_operation',
                          'process_ProcessingDetails_operationalStage_planning',
                          'process_ProcessingDetails_operationalStage_test',
                          'process_ProcessingDetails_operationalStage_rollout'
                        ]
                      },
              ...
              process_InformationObligations: {
                ...
                properties: {
                  ...
                  attributes: {
                    type: 'object',
                    properties: {
                      process_InformationObligations_informationObligations: {
                        title: 'Information obligations Art. 13, 14 GDPR',
                        type: 'string',
                        enum: [
                          'process_InformationObligations_informationObligations_done',
                          'process_InformationObligations_informationObligations_notdone'
                        ]
                      },
                      ...
                      process_InformationObligations_document: {
                        title: 'Document',
                        type: 'string',
                        format: 'uri'
                      }
              ...
              process_ExternalRecipient: {
                ...
                properties: {
                  ...
                  attributes: {
                    type: 'object',
                    properties: {
                      process_ExternalRecipient_ExternalRecipient: {
              ...
              process_JointControllership: {
                ...
                properties: {
                  ...
                  attributes: {
                    type: 'object',
                    properties: {
                      process_JointControllership_jointResponsiblePersons: {
                        title: 'Joint Responsible Persons?',
                        type: 'boolean'
                      }
                    }
                  }
          ...
          links: {
            ...
            properties: {
                ...
                items: {
                  ...
                  properties: {
                    ...
                    attributes: {
                      type: 'object',
                      properties: {
                        process_AffectedParties_supplementaryInformation: {
                ...
                items: {
                  ...
                  properties: {
                    ...
                    attributes: {
                      type: 'object',
                      properties: {
                        process_LegalBasis_explanation: {
                          title: 'Explanation',
                          type: 'string'
                        },
                        process_LegalBasis_document: {
                          title: 'Document',
                          type: 'string',
                          format: 'uri'
                        }
              ...
              process_LegalBasisForProcessingSensitiveData: {
                type: 'array',
                items: {
                  type: 'object',
                  properties: {
                    ...
                    description: {
                      type: 'string',
                      title: 'Description',
                      description: 'The description for this custom link.'
                    },
                    name: {
                      type: 'string',
                      title: 'Name',
                ...
                items: {
                  ...
                  properties: {
                    ...
                    attributes: {
                      type: 'object',
                      properties: {
                        process_InternalRecipient_purpose: {
                          title: 'Purpose of the internal data transfer',
                          type: 'string'
                        },
                        process_InternalRecipient_explanation: {
                          title: 'Explanation',
                          type: 'string'
                        },
                        process_InternalRecipient_document: {
                          title: 'Document',
                          type: 'string',
                          format: 'uri'
                        }
                ...
                items: {
                  ...
                  properties: {
                    ...
                    attributes: {
                      type: 'object',
                      properties: {
                        process_DataCategories_dataOrigin: {
                          title: 'Data Origin',
                          enum: [
                            'process_DataCategories_dataOrigin_direct',
                            'process_DataCategories_dataOrigin_transmission',
                            'process_DataCategories_dataOrigin_other'
                          ]
                        },
                        process_DataCategories_otherOrigin: {
                          title: 'Other Origin',
                          type: 'string'
                        },
                        process_DataCategories_comment: {
                          title: 'Comment',
                          type: 'string'
                        }
                      }
                ...
                items: {
                  ...
                  properties: {
                    ...
                    attributes: {
                      type: 'object',
                      properties: {
                        process_ExternalRecipient_purpose: {
                          title: 'Purpose of the external data transfer',
                          type: 'string'
                        },
                        process_ExternalRecipient_dataprocessingagreement: {
                          title: 'Data Processing Agreement?',
                          type: 'boolean'
                        },
                        process_ExternalRecipient_thirdcountry: {
                          title: 'Processing in a third country?',
                          type: 'boolean'
                        },
                        process_ExternalRecipient_thirdcountryname: {
                          title: 'Name of the third country?',
                          type: 'string',
                          format: 'uri'
                        },
                        process_ExternalRecipient_indication: {
                          title: 'Indication of appropriate guarantees',
                          type: 'string'
                        },
                        process_ExternalRecipient_explanation: {
                          title: 'Explanation',
                          type: 'string'
                        },
                        process_ExternalRecipient_document: {
                          title: 'Document',
                          type: 'string',
                          format: 'uri'
                        }
              ...
              process_jointResponsiblePersons: {
                type: 'array',
                items: {
                  type: 'object',
                  properties: {
              ...
              process_LegalBasisForProcessingInThirdCountry: {
                type: 'array',
                items: {
                  type: 'object',
                  properties: {
  ...
  mounted() {
    const bla = new ObjectSchemaHelper(this.schema as any)
    console.log(bla.getCustomAspects())
  }
})
</script>
