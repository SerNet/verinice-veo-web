    ...
    <BasePage v-if="locale === 'de'">
      <div class="d-flex justify-center">
        <BaseCard class="my-6" style="max-width: 500px; min-width: 500px">
          ...
          <v-col class="d-flex">
            <BaseCard :border="false">
              <v-card-title class="small-caps"> Meldung einer Schwachstelle </v-card-title>
              ...
              <v-card-text class="mt-6 text-justify">
                ...
                <p class="text-justify">
                  ...
                  rechnen Sie also mit einer gewissen Verzögerung, bis Sie eine Antwort erhalten. Sobald wir die
                  Schwachstelle bestätigt und diskutiert haben, werden wir Sie kontaktieren.
                </p>
              </v-card-text>
            </BaseCard>
          </v-col>
          ...
          <v-col class="d-flex">
            <BaseCard :border="false">
              <v-card-title class="small-caps"> Verantwortungsvolle Offenlegung </v-card-title>

              <v-card-text class="mt-6 text-justify">
                <p>
                  Der Fehler gehört Ihnen, aber bitte geben Sie uns genügend Zeit ihn zu beheben, bevor Sie ihn
                  veröffentlichen. Wir können bis zu 120 Tage brauchen, um die von Ihnen gemeldete Schwachstelle zu
                  schließen.
                </p>
                <p class="mt-4">
                  Sobald wir eine Lösung für die Sicherheitslücke veröffentlicht und Ihnen mitgeteilt haben, dass wir
                  damit fertig sind, können Sie den Fehler veröffentlichen.
                </p>
              </v-card-text>
              ...
              <v-list class="d-flex align-end">
                <v-list-item>
                  <template #prepend>
                    ...
                    <a class="text-decoration-none text-red" :href="mail">Kontakt</a>&nbsp; ( Bevorzugte Sprachen: DE,
                    EN )
                  </template>
                </v-list-item>
              </v-list>
    ...
    <BasePage v-else>
      <div class="d-flex justify-center">
        <BaseCard class="my-12" style="max-width: 500px; min-width: 500px">
          ...
          <v-col class="d-flex">
            <BaseCard class="mt-4" :border="false">
              <v-card-title class="small-caps"> Searching for Vulnerabilities </v-card-title>
              ...
              <v-card-text class="mt-6 text-justify">
                ...
                <ul class="mx-4">
                  ...
                  <li>Do not access customer data; use your own accounts where possible</li>
            ...
            <BaseCard :border="false">
              ...
              <v-card-text class="mt-6 text-justify">
                ...
                <p class="text-justify">
                  ...
                  until you get an answer. Once we confirmed and talked about the vulnerability, we will contact you.
                </p>
              </v-card-text>
            </BaseCard>
          </v-col>
          ...
          <v-col class="d-flex">
            <BaseCard :border="false">
              <v-card-title class="small-caps"> Responsible Disclosure </v-card-title>

              <v-card-text class="mt-6 text-justify">
                <p>
                  The bug stays yours, but please give us enough time to fix it before disclosing it. We may need up to
                  120 days to fix the vulnerability you reported.
                </p>
                <p class="mt-4">
                  Once we've published a fix for the vulnerability and told you we're done from our end, you can
                  disclose the bug.
                </p>
              </v-card-text>
              ...
              <v-list class="d-flex align-end">
                <v-list-item>
                  <template #prepend>
                    <v-icon :icon="mdiEmail" />
                    <a class="text-decoration-none text-red" :href="mail">Contact</a>&nbsp; ( Preferred languages: DE,
                    EN )
                  </template>
                </v-list-item>
              </v-list>
