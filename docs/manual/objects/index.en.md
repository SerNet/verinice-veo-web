...
1. in order to use depending upon setting of tasks the work surface optimally hide the two columns by means of Button or Tatstaur<br>PC: left column **Alt+1** / right column **Alt+2**<br>Mac: left column **Control+2** / right column **Control+2**.
...
1. use the *Hamburger menu* to select specific actions for the current object.
